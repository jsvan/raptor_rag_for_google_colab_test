...
"""
jsv: returns two substrings, cut on middle sentence.
"""
...
"""
def recursively_split_paragraphs(paragraph_list, maxlen=1500):
    good = []
    bad = paragraph_list
    while len(bad) > 0:
...
def split_text(
    essays: str, tokenizer: tiktoken.get_encoding("cl100k_base"), max_tokens: int, overlap: int = 0
):
    """
